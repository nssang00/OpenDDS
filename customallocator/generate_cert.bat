...
openssl x509 -req -in identity_ca_cert.csr -CA rootCA.crt -CAkey rootCA.key -CAcreateserial -out identity_ca_cert.pem -days 3650 -sha256
...
openssl x509 -req -in permissions_ca_cert.csr -CA rootCA.crt -CAkey rootCA.key -CAcreateserial -out permissions_ca_cert.pem -days 3650 -sha256
