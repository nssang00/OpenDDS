...
class VectorStyleRenderer {
  ...
  constructor(styleOrShaders, helper, enableHitDetection) {
    ...
    if (!isShaders) {
      ...
      shaders = {
        ...
        filterEvaluator: parseResult.filterEvaluator,//kmg
      };
    }
    ...
    this.filterEvaluator_ = shaders.filterEvaluator;//kmg
  ...
  generateRenderInstructions_(geometryBatch, transform) {
    console.log('geometryBatch', geometryBatch);
  ...
  renderInternal_(
    ...
    //if (!this.filterEvaluator_(evaluationContext)) {
    //  console.log('filterEvaluator_', this.filterEvaluator_);
    //  return ;
    //}
