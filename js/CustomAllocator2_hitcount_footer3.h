...
private:
    ...
    static const int BLOCK_ALLOC_SIZE = 32 * 1024;  // Memory pool size (32KB)
...
CustomAllocator::CustomAllocator() {
    ...
    while (block_size <= MAX_BLOCK_SIZE) {
        ...
        entry.numBlocks = max(BLOCK_ALLOC_SIZE / (block_size + BLOCK_HEADER_SIZE + BLOCK_FOOTER_SIZE), (size_t)MIN_BLOCKS_PER_ENTRY);  // Set the number of blocks
