...
//kmg
import {buildExpression as buildCpuExpression} from '../expr/cpu.js';
...
export function parseLiteralStyle(style) {
  ...
  const filterEvaluator =
    'filter' in style
      ? buildCpuExpression(style.filter, BooleanType, parsingContext)
      : (parsingContext) => true;
  ...
  return {
    ...
    uniforms: uniforms,
    filterEvaluator: filterEvaluator,//kmg
  };
}
